...
logger.log(
    `Deal delivery cron every ${DEAL_DELIVERY_CONFIG.POSTING_CRON_EVERY_SECONDS}s, lookahead ${DEAL_DELIVERY_CONFIG.POSTING_LOOKAHEAD_SECONDS}s`,
);

export const DEAL_DELIVERY_POSTING_CRON = `*/${DEAL_DELIVERY_CONFIG.POSTING_CRON_EVERY_SECONDS} * * * * *`;
